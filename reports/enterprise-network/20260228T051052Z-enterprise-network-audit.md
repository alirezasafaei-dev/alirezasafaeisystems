...
- Generated at: 2026-02-28T05:10:52.458Z
...
| cross_link_toolbox | PASS | expects toolbox cross-link |
| intent_router | PASS | expects intent-router section on homepage |

### audit (https://audit.alirezasafaeisystems.ir)
- Role: qualification_engine
- Root status: 200
- Ready status: 200
- Score: 100 (10 pass / 0 fail)
...
|---|---|---|
| MEDIUM | Phase 7: Conversion and Funnel Optimization | Baseline is clean; proceed with CTA experiments and funnel drop-off optimization. |
